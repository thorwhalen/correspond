...
| [`require`](#correspond.registry.require)(channel, key, \*[, config, run])          | A channel setting's value, or [`MissingRequirement`](correspond.errors.html.md#correspond.errors.MissingRequirement) saying how to set it. |
...
A channel setting’s value, or [`MissingRequirement`](correspond.errors.html.md#correspond.errors.MissingRequirement) saying how to set it.
