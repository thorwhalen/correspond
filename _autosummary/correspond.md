...
`audience`); asking for one it lacks raises [`NotSupported`](#correspond.NotSupported), and
...
the same verbs, through [`correspond.tools`](correspond.tools.md#module-correspond.tools).
...
| [`get_channel`](#correspond.get_channel)(name, \*[, registry])                | The adapter registered under `name`; [`UnknownChannel`](correspond.errors.md#correspond.errors.UnknownChannel) says what to do if there is none. |
...
| [`send`](#correspond.send)(ref, text, \*[, title, reply_to, ...])      | Send `text` (or a [`Draft`](correspond.model.md#correspond.model.Draft)) to a conversation; `dry_run` shows the plan and sends nothing.         |
...
* **Return type:**
  [`Account`](correspond.model.md#correspond.model.Account)
...
* **Return type:**
  [`Attachment`](correspond.model.md#correspond.model.Attachment)
...
* **Return type:**
  [`Support`](correspond.model.md#correspond.model.Support)
...
Bases: [`CorrespondError`](correspond.errors.md#correspond.errors.CorrespondError)
...
* **Return type:**
  [`ChannelIdentity`](correspond.model.md#correspond.model.ChannelIdentity)
...
* **Return type:**
  [`Event`](correspond.model.md#correspond.model.Event)
...
Bases: [`CorrespondError`](correspond.errors.md#correspond.errors.CorrespondError), [`ValueError`](https://docs.python.org/3/builtins/exceptions.html#ValueError)
...
* **Return type:**
  [`Message`](correspond.model.md#correspond.model.Message)
...
Bases: [`ChannelError`](correspond.errors.md#correspond.errors.ChannelError)
...
Bases: [`Stopped`](correspond.errors.md#correspond.errors.Stopped)
...
A result carrying a [`ChannelError`](correspond.errors.md#correspond.errors.ChannelError)’s classification.
...
Bases: [`CorrespondError`](correspond.errors.md#correspond.errors.CorrespondError), [`LookupError`](https://docs.python.org/3/builtins/exceptions.html#LookupError)
...
[`parse_ref()`](correspond.channels.github.md#correspond.channels.github.GitHub.parse_ref), so `binding_matches`, which
...
* **Return type:**
  [`Callable`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable)[[[`Message`](correspond.model.md#correspond.model.Message)], [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`None`](https://docs.python.org/3/builtins/constants.html#None)]
